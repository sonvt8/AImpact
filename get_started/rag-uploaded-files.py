    ...
    if st.session_state.processed_files:
        ...
        if query:
            with st.spinner("Generating response..."):
                ...
                # results: {'ids': [['e4cb69f4-563f-466f-9489-8ddaeca340ae', '79375d4a-6874-4ab4-a812-49a1436ac0dd', '36717003-59a1-4db4-9f3c-ff34ef6150fe']], 'embeddings': None, 'documents': [['chunk1', 'chunk2', 'chunk3']], 'uris': None, 'included': ['metadatas', 'documents', 'distances'], 'data': None, 'metadatas': [[{'source': 'linux-manual.pdf'}, {'source': 'linux-manual.pdf'}, {'source': 'linux-manual.pdf'}]], 'distances': [[0.6022868156433105, 0.8681057095527649, 0.873652994632721]]}
