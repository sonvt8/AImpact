...
def streamlit_app():
    st.set_page_config(page_title="Daily Facts RAG", layout="wide")
    st.title("📰 Daily Facts RAG System")
    ...
    with st.expander("📚 Available Daily Facts", expanded=False):
    ...
    query = st.text_input(
        ...
        placeholder="e.g., In which month of 2025 will a Southeast Asian nation hold elections emphasizing environmental goals?",
    )
